...
// Exercise 38
// Write a function definition named sumOfSquares that takes in two numbers, squares each number,
// then returns the sum of both squares.

function sumOfSquares(num, num1){
    var x = Math.pow(num, 2);
    var y = Math.pow(num1, 2);
    var sum = x + y;
    return sum;
...
// Exercise 42
// Write a function definition named circumference that takes in a number representing a circle's
...
// Exercise 43
// Review this code carefully https://gist.github.com/ryanorsinger/5627b954d119dabb3d8c44d56b38c354
// if you want more guidance on Exercises 43, 44, and 45.
// Write a function definition named isVowel that takes in value and returns
// true if the value is a, e, i, o, u in upper or lower case.

function isVowel (input){
    if (input === "a" || input === "e" || input === "a" || input === "e" || input === "u");
    return true;
} else if (input === "A" || input === "E" || input === "a" || input === "e" || input === "u") {
    return true;
} else {
    return false;
}
